"""
TTSPN model and criterion classes.
...
from .segmentation import (TTSPNsegm, PostProcessSegm,
                           dice_loss, sigmoid_focal_loss)

                           
from .transformer import build_transformer
from .spn import SinLayer, SinLayerClass



class TTSPN(nn.Module):
    """ This is the TTSPN module that performs video object detection """
    def __init__(self,
        backbone,
        transformer,
        num_classes,
        ...
        Parameters:
            ...
            num_queries: number of object queries, ie detection slot. This is the maximal number of objects
                         TTSPN can detect in a video. For ytvos, we recommend 10 queries for each frame, 
        ...
        self.class_embed = SinLayerClass(hidden_dim, 128, num_classes + 1)
        self.bbox_embed = SinLayer(hidden_dim, 128, 4)
...
class SetCriterion(nn.Module):
    """ This class computes the loss for TT-SPN.
