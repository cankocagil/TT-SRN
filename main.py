...
def main(args):
    ...
    del checkpoint["ttspn.class_embed.weight"]
    del checkpoint["ttspn.class_embed.bias"]
    del checkpoint["ttspn.query_embed.weight"]
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('TT-SPN training and evaluation script', parents=[get_args_parser()])
